...
namespace biosl5
{
    class bInteger
    {
                    ...
                    if (!isDirect)
                    {
                        ...
                        while (!isDone)
                        {
                            ...
                            try //if the user did not enter an value, then its no good, return a random value.
                            {
                                ...
                                x = int.Parse(_terms[0]);
                                _operator = _terms[1]; //*, /, +, -      (mathOperators)
                                y = int.Parse(_terms[2]);
        ...
        static int doExpression(string operation) //example : "2 * 3"
        {
            ...
            try
            {
                int x = int.Parse(words[0]); //must be signed
                int y = int.Parse(words[2]); //must be signed
        ...
        static int getValue(string newVal)
        {
            try
            {
