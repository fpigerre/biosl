...
namespace biosl5
{
    class bDouble
    {
                    ...
                    if (!isDirect)
                    {
                        ...
                        while (!isDone)
                        {
                            ...
                            try //if the user did not enter an value, then its no good, return a random value.
                            {
                                ...
                                x = double.Parse(_terms[0]);
                                _operator = _terms[1]; //*, /, +, -      (mathOperators)
                                y = double.Parse(_terms[2]);
        ...
        static double doExpression(string operation) //example : "2 * 3"
        {
            ...
            try
            {
                double x = double.Parse(words[0]); //must be signed
                double y = double.Parse(words[2]); //must be signed
        ...
        static double getValue(string newVal)
        {
            try
            {
